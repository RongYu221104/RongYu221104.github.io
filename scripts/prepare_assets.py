...
TRACKS = {
    ...
    "Bill Evans - B Minor Waltz.mp3": "b-minor-waltz",
    "Bill Evans - Gary's Theme.mp3": "garys-theme",
    "Bill Evans - We Will Meet Again.mp3": "we-will-meet-again",
    "Bill Evans - The Peacocks.mp3": "the-peacocks",
    "Bill Evans - Sometime Ago.mp3": "sometime-ago",
    "Bill Evans - You Must Believe In Spring.mp3": "you-must-believe-in-spring",
    "Bill Evans - Without A Song.mp3": "without-a-song",
    "Bill Evans - Freddie Freeloader.mp3": "freddie-freeloader-evans",
    "Bill Evans - All Of You.mp3": "all-of-you",
